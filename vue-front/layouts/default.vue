  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="#" title="墨课学院">
            <img src="~/assets/img/logo.png" width="100%" alt="墨课学院">
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="https://github.com/YUEQIN18" title="欢迎访问我的GitHub" target="_blank">GitHub</a>
            </li>
          </ul>
          <div class="clear"></div>
        </div>
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>服务热线：010-12345678(北京)</span>
                <span>Email：qinyue12345@gmail.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2022 没有版权 全部开源</span>
              </section>
            </section>
          </section>
